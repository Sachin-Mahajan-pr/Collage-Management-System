...
urlpatterns = [
    ...
    # New Admin Routes
    path("admin/user/block/<int:user_id>", hod_views.block_unblock_user, name='block_unblock_user'),
    path("admin/user/bulk_delete", hod_views.delete_user_bulk, name='delete_user_bulk'),
    ...
    path("admin/timetable/edit/<int:timetable_id>", hod_views.edit_timetable, name='edit_timetable'),
    path("admin/timetable/delete/<int:timetable_id>", hod_views.delete_timetable, name='delete_timetable'),
    path("admin/activity/manage", hod_views.manage_activity, name='manage_activity'),
    path("admin/activity/add", hod_views.add_activity, name='add_activity'),
    path("admin/activity/edit/<int:activity_id>", hod_views.edit_activity, name='edit_activity'),
    path("admin/activity/delete/<int:activity_id>", hod_views.delete_activity, name='delete_activity'),
    path("admin/fees/manage", hod_views.manage_fee_structure, name='manage_fee_structure'),
    path("admin/fees/add", hod_views.add_fee_structure, name='add_fee_structure'),
    path("admin/fees/status", hod_views.student_fee_status, name='student_fee_status'),
    path("admin/fees/toggle/<int:payment_id>", hod_views.toggle_fee_status, name='toggle_fee_status'),

    # New Student Routes
    path("student/timetable", student_views.student_view_timetable, name='student_view_timetable'),
    path("student/fees", student_views.student_view_fees, name='student_view_fees'),
    path("student/search", student_views.search_college_info, name='search_college_info'),

    # New Staff Routes
    path("staff/timetable", staff_views.staff_view_timetable, name='staff_view_timetable'),
    path("staff/salary", staff_views.staff_view_salary, name='staff_view_salary'),
]
